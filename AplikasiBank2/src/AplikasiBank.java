...
class AkunBank {
    ...
    public void Setoran(double jumlah, String bulan) {
        saldo += jumlah;
        transaksiList.add(new Transaksi("Setoran", jumlah, bulan));
    }
...
public class AplikasiBank {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            System.out.println("\nSELAMAT DATANG DI BANK SENDIRI");
            System.out.println("\n1. Cek Saldo Anda");
            ...
            switch (pilihan) {
                ...
                case 5:
                    running = false;
                    System.out.println("TERIMA KASIH TELAH MELAKUKAN TRANSAKSI DI BANK KAMI. SEMOGA HARI HARI ANDA MENYENANGKAN");
                    break;
                default:
